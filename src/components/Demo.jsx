...
const Demo = () => {
    ...
    <section className="w-full mt-16 max-w-xl">
        <h2 className="text-black-500 font-semibold">
            Put your link or URL and paste in the application given provides you the proper explanation summary of the website.
        </h2>
        <div className="flex flex-col w-full gap-2">
            <form className="flex justify-center relative items-center" onSubmit={handleSubmit}>
            ...
            <img src={loader} alt='loader' className='w-20 h-20 object-contain' />
                ...
                article.summary && (
                    <div className='flex flex-col gap-3'>
                        <h2 className='font-satoshi font-bold text-black-600 text-xl'>
